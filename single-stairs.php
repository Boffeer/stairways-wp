...
<section id="section-product-difference" class="sect-carcas section section-product-difference">
    <div class="container sect-carcas__container">
        <div class="sect-carcas--info">
            <?php $accuracy = array(
                'title' => carbon_get_post_meta(get_the_ID(), 'accuracy_title'),
                'bullets' => explode_textarea_matrix(carbon_get_post_meta(get_the_ID(), 'accuracy_bullets')),
                'hint' => carbon_get_post_meta(get_the_ID(), 'accuracy_hint'),
            ); ?>
